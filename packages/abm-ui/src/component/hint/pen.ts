...
export class PenHint extends HintBase<PenHintKey, PenHintProp> {
	protected static style = css`
		...
		.pen,
		.Tap .tap,
		.DualTap :is(.tap, .tap-2),
		.Draw .draw,
		.DrawHorizontal .draw-left,
		.DrawHorizontal .draw-right,
		.DrawVertical .draw-up,
		.DrawVertical .draw-down,
	...
	protected validate(key: unknown): key is PenHintKey | undefined {
